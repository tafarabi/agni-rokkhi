    ...
    <div class="container" style="background:#164B8D;width:100%;">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right hidden-xs hidden-sm">
                <li class="gold"><a href="javascript:;"><button class="  btn btn-gradient outline-button" style="margin-bottom: 0px;" data-toggle="modal" data-target="#pop-register">
                            <div style="background: #1C589B;transition: all 0.3s;">Register</div>
                        </button></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right hidden-xs hidden-sm">
                <li class="gold"><a href="javascript:;"><button class="  btn btn-gradient outline-button" style="margin-bottom: 0px;" data-toggle="modal" data-target="#pop-login">
                            <div style="background: #1C589B;transition: all 0.3s;">Login</div>
                        </button></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right hidden-xs hidden-sm">
...
-->
    ...
    <popups>
                ...
                <div class="modal-content">
					...
					<?php registration_user(); ?>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-gradient" name="registration">Register</button>
                        </div>
                    </form>
                </div>
        ...
        <!-- Login Popup -->
        <div id="pop-login" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" data-aos="zoom-in-up" data-aos-duration="800">&times;</button>
                        <h3 class="modal-title  blue oR m0">LOGIN</h3>
                        <span class="light oR" style="font-size: 14px">Enter your informations to login.</span>
                    </div>
                    <form method="POST">
					<?php login_user(); ?>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-gradient" name="login">Login</button>
                        </div>
                    </form>
                </div>
